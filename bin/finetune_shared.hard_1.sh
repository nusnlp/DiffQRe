...
## code for qrecc
#export DATA_DIR=/home/yehai/diff-qre/data/data_with_domain_id/hard_1/
#export OUT_DIR=../output/hard_1_wo_pre_train_result/qrecc
...
#export DATA_DIR=/home/yehai/diff-qre/data/data_with_domain_id/hard_1/
#export OUT_DIR=../output/hard_1_w_pre_train_result/qrecc/lr=1e-5
#export MODEL_ENSEMBLE=False
#export DISTILL=False
#export round=round
...
#export DATA_DIR=../data/data_with_domain_id/hard_1/
#export OUT_DIR=../output/hard_1_w_pre_train_result/cannard/lr=1e-5
#export MODEL_ENSEMBLE=False
#export DISTILL=False
#export round=round
...
export DATA_DIR=../data/data_with_domain_id/hard_1/
export OUT_DIR=../output/hard_1_wo_pre_train_result/cannard/lr=1e-4/rerun
export MODEL_ENSEMBLE=False
export DISTILL=False
export round=round
