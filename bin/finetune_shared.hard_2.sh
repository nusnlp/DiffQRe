...
#export DATA_DIR=/home/yehai/diff-qre/data/data_with_domain_id/hard_2/
#export OUT_DIR=../output/hard_2_wo_pre_train_result/qrecc
#export MODEL_ENSEMBLE=False
#export DISTILL=False
#export round=round


#for seed in 456  #2378 9837 456
#do
...
#export DATA_DIR=/home/yehai/diff-qre/data/data_with_domain_id/hard_2/
#export OUT_DIR=../output/hard_2_w_pre_train_result/qrecc/lr=1e-5
#export MODEL_ENSEMBLE=False
#export DISTILL=False
#export round=round
...
#export OUT_DIR=../output/hard_2_w_pre_train_result/cannard/lr=1e-5
#export MODEL_ENSEMBLE=False
#export DISTILL=False
#export round=round
...
export DATA_DIR=../data/data_with_domain_id/hard_2/
export OUT_DIR=../output/hard_2_wo_pre_train_result/cannard/lr=1e-4
export MODEL_ENSEMBLE=False
export DISTILL=False
export round=round
