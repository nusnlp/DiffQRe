...
class RobertaEncoderDetached(nn.Module):
    """Added by Linlin
       ...
       Roberta encoder with freezed parameters.
    """
...
class RobertaModelWithWrapper(RobertaModelOrig):
    """Added by Linlin
       ...
       Roberta wrapper, similar logic as BERT.
    """
    authorized_missing_keys = [r"position_ids"]
        ...
        if select_wrapper is None:
            ...
            if wrapper_config_path is not None:
                ...
                if select_wrapper in wrapper_config:
                    ...
                    print('*' * 20)
            self.encoder = RobertaEncoderDetached(config, wrapper_config=self.wrapper_config)
